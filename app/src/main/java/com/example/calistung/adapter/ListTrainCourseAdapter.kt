...
class ListTrainCourseAdapter(items: ArrayList<Train>) : ListAdapter<Train>(items) {
    override fun applyText(item: Train): String {
        return item.name.toString()
    }

    override fun clicked(item: Train, context: Context) {
